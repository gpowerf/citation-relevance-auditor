...
description: "Use when the user asks to audit, verify, or check citations, references, or in-text citations in an academic paper. Also use when the user says 'citation relevance', 'check references', or 'audit citations'. Gate on terms like 'citation', 'reference', 'audit', 'verify', 'relevance' in combination with 'paper' or 'manuscript'."
---
